...
public class MainFrame extends JFrame {
	private static final String TITLE = "�̹��� ������";
	...
	private void run() {
		...
		menu = new JMenu("���� Ž��");
		fileLoader = new JMenuItem("���� ����");
		fileSaver = new JMenuItem("���� ����");
		...
		buttonPanel.getBrightnessControl().addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(isBrightControlPressed) {
					...
					buttonPanel.getBrightnessControl().setColor("��� ����", new Color(61,205,91));
					slider.setVisible(false);
				}
				else {
					isBrightControlPressed = true;
					buttonPanel.getBrightnessControl().setColor("��� ����", Color.GRAY);
